                      ...
                      children: [
                        ...
                        SizedBox(
                            ...
                            child: CustomDriverCarPicker(
                              ...
                              driverorcarpicker: globalvariables.license,
                              onPressed: () {
                            ...
                            return Padding(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(globalvariables.licenseNo[i],
                                        style: TextStyle(
                                            fontFamily: 'Euclid Regular',
                                            fontSize: 18)),
                                    Radio(
                                      value: i,
                                      groupValue: globalvariables.chosenlicence,
                                      onChanged: (value) {
                                        globalvariables.chosenlicence =
                                            i.toString();
                                        globalvariables.license =
                                            globalvariables.licenseNo[i];
                                        globalvariables
                                            .addData(globalvariables.license);
                                      },
                                    )
                                  ],
                                ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Center(
                      child: GestureDetector(
                        onTap: () {
                          globalvariables.addData(globalvariables.driverEditor);
                          Navigator.of(context).pop();
                        },
                        child: Container(
                          height: height * 0.05,
